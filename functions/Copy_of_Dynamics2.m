...
vdot_b=[0 ;0; -m_t*model.g]+R_b_e*[0; 0; T_total]; % Linear Acceleration
dU=vdot_b(1); 
dV=vdot_b(2); 
dW=vdot_b(3);
...
ang_acc_x=((I_yy-I_zz)/I_xx)*q*r+(model.l/I_xx)*Tau_x;
ang_acc_y=((I_zz-I_xx)/I_yy)*q*r+(model.l/I_yy)*Tau_y;
ang_acc_z=((I_xx-I_yy)/I_zz)*q*r+(model.l/I_zz)*Tau_z;
