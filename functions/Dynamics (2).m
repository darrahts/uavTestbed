...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%{
 This Level-2 S-Function simulates the behavior of an octocopter 
%}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
block.OutputPort(13).Dimensions=12;
...
ICDerivatives     = block.DialogPrm(3).Data;
%      if ~exist(model)
...
% IC.P, IC.Q, IC.R are in deg/s ... convert to rad/s
P = IC.P; Q = IC.Q; R = IC.R;
% IC.Phi, IC.The, IC.Psi are in deg ... convert to rads
Phi = IC.Phi; The = IC.The; Psi = IC.Psi;
...
f = [ICDerivatives.dP ICDerivatives.dQ ICDerivatives.dR ICDerivatives.dPhi ...
    ICDerivatives.dTheta ICDerivatives.dPsi ICDerivatives.dU ICDerivatives.dV ...
    ICDerivatives.dW ICDerivatives.dX ICDerivatives.dY ICDerivatives.dZ].';
% block.Derivatives.Data=f;
% for i=1:12
%     block.Derivatives(i).Data=f(i);
% end
block.OutputPort(13).Data = f;
...
if isempty(block.Derivatives.Data)
    block.OutputPort(13).Data = zeros(12,1);
else
    block.OutputPort(13).Data = block.Derivatives.Data;
end
...
% model.lx - height of the cube in x axe (height=width)
% model.ly - height of the cube in y axe
% model.lz - height of the cube in z axe

%% rotation matrix
% Z-Y-X rotation convention from the inertial frame to the body frame, and
% X-Y-X from the body frame to the inertial frame
...
% v_wenom=[0 12 0]'; % nominal wind velocity in m/s in inertial frame
...
v_a=v_wb+v_b; % apparent velocity resulting from wind and body velocities
