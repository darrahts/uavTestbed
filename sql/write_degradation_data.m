...
if true_ctr > lookback
    ...
    degradation_tb = table(mission_id, q_deg(true_ctr), q_var(true_ctr), q_poly(1), q_poly(2), ...
        r_deg(true_ctr), r_var(true_ctr), r_poly(1), r_poly(2), m_deg(true_ctr), m_var(true_ctr), ...
    ...
    degradation_tb = table(mission_id, q_deg(true_ctr), q_var(true_ctr), r_deg(true_ctr), ...
        r_var(true_ctr), m_deg(true_ctr), m_var(true_ctr), battery.id, Motor2.id, octomodel.id, ...
        'VariableNames', degradation_tb_cols);
end
%disp(degradation_tb)
