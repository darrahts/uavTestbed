...
do $$
	...
	begin
		...
		-- insert into process_tb("type_id", "description", "source", "parameters") 
		-- 	values 
		-- 		(r_deg_id, 'continuous usage based v3','NASA prognostics data set', '{"r_coef":[1.1294e-09, 5.2823e-06, 0.00016165]}'), 
		-- 		(r_deg_id, 'continuous usage based v4','NASA prognostics data set', '{"r_coef":[1.0478e-09, 8.3345e-06, 0.00077806]}'), 
		-- 		(r_deg_id, 'continuous usage based v5','NASA prognostics data set', '{"r_coef":[1.1183e-09, 3.3089e-06, 0.00090516]}'), 
		-- 		(r_deg_id, 'continuous usage based v6','NASA prognostics data set', '{"r_coef":[9.8919e-10, 1.1268e-05, 0.0010118]}'), 
		-- 		(r_deg_id, 'continuous usage based v7','NASA prognostics data set', '{"r_coef":[1.0161e-09, 1.0318e-05, 0.0012684]}'), 
		-- 		(r_deg_id, 'continuous usage based v8','NASA prognostics data set', '{"r_coef":[1.0489e-09, 7.9621e-06, 0.0012351]}'), 
		-- 		(r_deg_id, 'continuous usage based v9','NASA prognostics data set', '{"r_coef":[1.1167e-09, 7.6871e-06, 0.0010821]}'), 
		-- 		(r_deg_id, 'continuous usage based v10','NASA prognostics data set', '{"r_coef":[1.1883e-09, 8.1783e-06, 0.00088917]}'), 
		-- 		(r_deg_id, 'continuous usage based v11','NASA prognostics data set', '{"r_coef":[1.0612e-09, 7.2968e-06, 0.00095831]}'),
		-- 		(r_deg_id, 'continuous usage based v12','NASA prognostics data set', '{"r_coef":[1.1361e-09, 7.0762e-06, 0.00076092]}'), 
		-- 		(r_deg_id, 'continuous usage based v13','NASA prognostics data set', '{"r_coef":[1.2335e-09, 3.8866e-06, 0.0011773]}'), 
		-- 		(r_deg_id, 'continuous usage based v14','NASA prognostics data set', '{"r_coef":[1.1001e-09, 3.5642e-06, 0.0011289]}'), 
		-- 		(r_deg_id, 'continuous usage based v15','NASA prognostics data set', '{"r_coef":[1.0602e-09, 7.7006e-06, 0.00080667]}'), 
		-- 		(r_deg_id, 'continuous usage based v16','NASA prognostics data set', '{"r_coef":[1.1607e-09, 4.1001e-06, 0.00096838]}'), 
		-- 		(r_deg_id, 'continuous usage based v17','NASA prognostics data set', '{"r_coef":[1.1107e-09, 8.3261e-06, 0.0010745]}'), 
		-- 		(r_deg_id, 'continuous usage based v18','NASA prognostics data set', '{"r_coef":[1.0691e-09, 7.8016e-06, 0.0012353]}'), 
		-- 		(r_deg_id, 'continuous usage based v19','NASA prognostics data set', '{"r_coef":[1.0897e-09, 5.3311e-06, 0.00089862]}'), 
		-- 		(r_deg_id, 'continuous usage based v20','NASA prognostics data set', '{"r_coef":[9.5051e-10, 1.1776e-05, 0.0011358]}'), 
		-- 		(r_deg_id, 'continuous usage based v21','NASA prognostics data set', '{"r_coef":[1.1549e-09, 7.7982e-06, 0.0008638]}'), 
		-- 		(r_deg_id, 'continuous usage based v22','NASA prognostics data set', '{"r_coef":[1.0911e-09, 4.3271e-06, 0.0010865]}'), 
		-- 		(r_deg_id, 'continuous usage based v23','NASA prognostics data set', '{"r_coef":[1.0522e-09, 5.1022e-06, 0.001177]}'), 
		-- 		(r_deg_id, 'continuous usage based v24','NASA prognostics data set', '{"r_coef":[1.1319e-09, 6.5058e-06, 0.0012583]}'), 
		-- 		(r_deg_id, 'continuous usage based v25','NASA prognostics data set', '{"r_coef":[1.1568e-09, 1.0167e-05, 0.0010427]}'), 
		-- 		(r_deg_id, 'continuous usage based v26','NASA prognostics data set', '{"r_coef":[1.1649e-09, 2.4538e-06, 0.00090003]}'), 
		-- 		(r_deg_id, 'continuous usage based v27','NASA prognostics data set', '{"r_coef":[9.9541e-10, 7.9112e-06, 0.00089331]}'), 
		-- 		(r_deg_id, 'continuous usage based v28','NASA prognostics data set', '{"r_coef":[1.0513e-09, 9.2434e-06, 0.00014513]}'), 
		-- 		(r_deg_id, 'continuous usage based v29','NASA prognostics data set', '{"r_coef":[1.072e-09, 6.8163e-06, 0.0011601]}'), 
		-- 		(r_deg_id, 'continuous usage based v30','NASA prognostics data set', '{"r_coef":[1.2079e-09, 7.7673e-06, 0.0010309]}'), 
		-- 		(r_deg_id, 'continuous usage based v31','NASA prognostics data set', '{"r_coef":[1.1122e-09, 6.2652e-06, 0.00085638]}'), 
		-- 		(r_deg_id, 'continuous usage based v32','NASA prognostics data set', '{"r_coef":[1.1279e-09, 4.4207e-06, 0.00012717]}'), 
		-- 		(r_deg_id, 'continuous usage based v33','NASA prognostics data set', '{"r_coef":[1.1468e-09, 5.4803e-06, 0.00086257]}'), 
		-- 		(r_deg_id, 'continuous usage based v34','NASA prognostics data set', '{"r_coef":[1.1393e-09, 4.9868e-06, 0.00034725]}'), 
		-- 		(r_deg_id, 'continuous usage based v35','NASA prognostics data set', '{"r_coef":[1.0307e-09, 5.8412e-06, 0.0012307]}'), 
		-- 		(r_deg_id, 'continuous usage based v36','NASA prognostics data set', '{"r_coef":[1.0531e-09, 7.1902e-06, 0.0012358]}'), 
		-- 		(r_deg_id, 'continuous usage based v37','NASA prognostics data set', '{"r_coef":[1.1467e-09, 6.5415e-06, 0.0010653]}'), 
		-- 		(r_deg_id, 'continuous usage based v38','NASA prognostics data set', '{"r_coef":[1.1636e-09, 6.4791e-06, 0.00085855]}'), 
		-- 		(r_deg_id, 'continuous usage based v39','NASA prognostics data set', '{"r_coef":[1.0011e-09, 7.4917e-06, 0.001134]}'), 
		-- 		(r_deg_id, 'continuous usage based v40','NASA prognostics data set', '{"r_coef":[1.0844e-09, 8.9884e-06, 0.00099465]}'), 
		-- 		(r_deg_id, 'continuous usage based v41','NASA prognostics data set', '{"r_coef":[1.0513e-09, 3.4106e-06, 0.0014724]}'), 
		-- 		(r_deg_id, 'continuous usage based v42','NASA prognostics data set', '{"r_coef":[1.1885e-09, 7.7164e-06, 0.0009792]}'), 
		-- 		(r_deg_id, 'continuous usage based v43','NASA prognostics data set', '{"r_coef":[1.083e-09, 7.2783e-06, 0.0011117]}'), 
		-- 		(r_deg_id, 'continuous usage based v44','NASA prognostics data set', '{"r_coef":[1.113e-09, 2.7881e-06, 0.00089019]}'), 
		-- 		(r_deg_id, 'continuous usage based v45','NASA prognostics data set', '{"r_coef":[1.0947e-09, 3.9821e-06, 0.0012366]}'), 
		-- 		(r_deg_id, 'continuous usage based v46','NASA prognostics data set', '{"r_coef":[1.0256e-09, 9.8263e-06, 0.001007]}'), 
		-- 		(r_deg_id, 'continuous usage based v47','NASA prognostics data set', '{"r_coef":[1.0047e-09, 6.8082e-06, 0.00034449]}'), 
		-- 		(r_deg_id, 'continuous usage based v48','NASA prognostics data set', '{"r_coef":[1.1131e-09, 5.4317e-06, 0.0011638]}'), 
		-- 		(r_deg_id, 'continuous usage based v49','NASA prognostics data set', '{"r_coef":[1.0874e-09, 2.8645e-06, 0.001147]}'), 
		-- 		(r_deg_id, 'continuous usage based v50','NASA prognostics data set', '{"r_coef":[1.1299e-09, 4.7247e-06, 0.0010075]}'),
		-- 		(r_deg_id, 'continuous usage based v51','NASA prognostics data set', '{"r_coef":[1.0069e-09, 6.1143e-06, 0.00088017]}'), 
		-- 		(r_deg_id, 'continuous usage based v52','NASA prognostics data set', '{"r_coef":[1.0666e-09, 7.03e-06, 0.0011617]}');
		
		insert into process_tb("type_id", "description", "source", "parameters") 
			values 
				(q_deg_id, 'continuous usage based v4','experimentation', '{"r_coef":[-1.8078e-07, 0.00017066, 22.118]}'), 
				(q_deg_id, 'continuous usage based v5','experimentation', '{"r_coef":[-3.1391e-07, 0.00014561, 22.138]}'), 
				(q_deg_id, 'continuous usage based v6','experimentation', '{"r_coef":[-2.6836e-07, 0.0001, 22.033]}'), 
				(q_deg_id, 'continuous usage based v7','experimentation', '{"r_coef":[-1.988e-07, 0.00023657, 22.442]}'), 
				(q_deg_id, 'continuous usage based v8','experimentation', '{"r_coef":[-2.5887e-07, 0.00020873, 22.156]}'), 
				(q_deg_id, 'continuous usage based v9','experimentation', '{"r_coef":[-2.2579e-07, 0.00012841, 22.038]}'), 
				(q_deg_id, 'continuous usage based v10','experimentation', '{"r_coef":[-2.1245e-07, -3.4485e-05, 22.265]}'), 
				(q_deg_id, 'continuous usage based v11','experimentation', '{"r_coef":[-3.8312e-07, 0.00030525, 22.001]}'), 
				(q_deg_id, 'continuous usage based v12','experimentation', '{"r_coef":[-2.0152e-07, 0.00011599, 22.043]}'), 
				(q_deg_id, 'continuous usage based v13','experimentation', '{"r_coef":[-2.6383e-07, 0.00025113, 22.316]}'), 
				(q_deg_id, 'continuous usage based v14','experimentation', '{"r_coef":[-1.9644e-07, 0.00012371, 22.024]}'), 
				(q_deg_id, 'continuous usage based v15','experimentation', '{"r_coef":[-2.698e-07, 0.00027073, 22.067]}'), 
				(q_deg_id, 'continuous usage based v16','experimentation', '{"r_coef":[-3.0568e-07, 0.00018225, 21.999]}'), 
				(q_deg_id, 'continuous usage based v17','experimentation', '{"r_coef":[-2.2463e-07, 0.00024673, 22.01]}'), 
				(q_deg_id, 'continuous usage based v18','experimentation', '{"r_coef":[-2.1259e-07, 0.00024519, 22.052]}'), 
				(q_deg_id, 'continuous usage based v19','experimentation', '{"r_coef":[-2.4456e-07, 1.1158e-05, 22.266]}'), 
				(q_deg_id, 'continuous usage based v20','experimentation', '{"r_coef":[-3.2731e-07, 0.00040936, 21.985]}'), 
				(q_deg_id, 'continuous usage based v21','experimentation', '{"r_coef":[-3.1822e-07, 0.0002692, 21.996]}'), 
				(q_deg_id, 'continuous usage based v22','experimentation', '{"r_coef":[-1.9867e-07, 0.00018712, 22.108]}'), 
				(q_deg_id, 'continuous usage based v23','experimentation', '{"r_coef":[-2.5529e-07, 0.00011922, 22.042]}'), 
				(q_deg_id, 'continuous usage based v24','experimentation', '{"r_coef":[-2.7603e-07, 0.00016847, 22.138]}'), 
				(q_deg_id, 'continuous usage based v25','experimentation', '{"r_coef":[-2.7725e-07, 0.00016742, 22.047]}'), 
				(q_deg_id, 'continuous usage based v26','experimentation', '{"r_coef":[-2.94e-07, 0.0002807, 22.035]}'), 
				(q_deg_id, 'continuous usage based v27','experimentation', '{"r_coef":[-2.804e-07, 0.00012701, 22.377]}'), 
				(q_deg_id, 'continuous usage based v28','experimentation', '{"r_coef":[-2.5502e-07, 0.00017579, 22.075]}'), 
				(q_deg_id, 'continuous usage based v29','experimentation', '{"r_coef":[-2.0989e-07, 9.8453e-05, 22.056]}'), 
				(q_deg_id, 'continuous usage based v30','experimentation', '{"r_coef":[-1.8723e-07, 4.9151e-05, 22.323]}'), 
				(q_deg_id, 'continuous usage based v31','experimentation', '{"r_coef":[-2.6706e-07, 0.00022269, 22.037]}'), 
				(q_deg_id, 'continuous usage based v32','experimentation', '{"r_coef":[-2.2291e-07, -2.1074e-05, 22.239]}'), 
				(q_deg_id, 'continuous usage based v33','experimentation', '{"r_coef":[-2.4769e-07, 0.00019795, 22.021]}'), 
				(q_deg_id, 'continuous usage based v34','experimentation', '{"r_coef":[-1.493e-07, 4.9594e-05, 22.043]}'), 
				(q_deg_id, 'continuous usage based v35','experimentation', '{"r_coef":[-2.4435e-07, 0.00019649, 22.18]}'), 
				(q_deg_id, 'continuous usage based v36','experimentation', '{"r_coef":[-2.258e-07, -4.8861e-05, 22.079]}'), 
				(q_deg_id, 'continuous usage based v37','experimentation', '{"r_coef":[-2.4593e-07, 0.0001427, 22.048]}'), 
				(q_deg_id, 'continuous usage based v38','experimentation', '{"r_coef":[-2.6146e-07, 0.00018312, 22.032]}'), 
				(q_deg_id, 'continuous usage based v39','experimentation', '{"r_coef":[-2.418e-07, 0.00029457, 22.304]}'), 
				(q_deg_id, 'continuous usage based v40','experimentation', '{"r_coef":[-2.5268e-07, -9.3172e-06, 22.417]}'), 
				(q_deg_id, 'continuous usage based v41','experimentation', '{"r_coef":[-2.9247e-07, 0.00015378, 22.19]}'), 
				(q_deg_id, 'continuous usage based v42','experimentation', '{"r_coef":[-2.9094e-07, 0.00034185, 21.977]}'), 
				(q_deg_id, 'continuous usage based v43','experimentation', '{"r_coef":[-3.5276e-07, 0.00026037, 21.996]}'), 
				(q_deg_id, 'continuous usage based v44','experimentation', '{"r_coef":[-2.2276e-07, 0.00010628, 22.063]}'), 
				(q_deg_id, 'continuous usage based v45','experimentation', '{"r_coef":[-2.2881e-07, 0.00031787, 22.264]}'), 
				(q_deg_id, 'continuous usage based v46','experimentation', '{"r_coef":[-3.8328e-07, 0.00012019, 22.057]}'), 
				(q_deg_id, 'continuous usage based v47','experimentation', '{"r_coef":[-2.8472e-07, 0.00027558, 22.139]}'), 
				(q_deg_id, 'continuous usage based v48','experimentation', '{"r_coef":[-2.6094e-07, 4.4985e-05, 22.481]}'), 
				(q_deg_id, 'continuous usage based v49','experimentation', '{"r_coef":[-2.6035e-07, 0.00025114, 22.158]}'), 
				(q_deg_id, 'continuous usage based v50','experimentation', '{"r_coef":[-3.3557e-07, 0.00010062, 22.06]}'), 
				(q_deg_id, 'continuous usage based v51','experimentation', '{"r_coef":[-4.1174e-07, 0.00042333, 22.104]}'), 
				(q_deg_id, 'continuous usage based v52','experimentation', '{"r_coef":[-2.2797e-07, 0.00022527, 22.138]}'), 
				(q_deg_id, 'continuous usage based v53','experimentation', '{"r_coef":[-2.7947e-07, 0.00028487, 22.495]}');

		-- insert into process_tb("type_id", "description", "source", "parameters") 
		-- 	values 
		-- 		(q_deg_id, 'continuous usage based v4','NASA prognostics data set', '{"q_coef":[-3.191e-07, -0.00013332, 21.79]}'), 
		-- 		(q_deg_id, 'continuous usage based v5','NASA prognostics data set', '{"q_coef":[-4.75e-07, 0.0001639, 21.789]}'), 
		-- 		(q_deg_id, 'continuous usage based v6','NASA prognostics data set', '{"q_coef":[-3.5212e-07, -6.4532e-05, 21.975]}'), 
		-- 		(q_deg_id, 'continuous usage based v7','NASA prognostics data set', '{"q_coef":[-3.9358e-07, 0.00023988, 22.151]}'), 
		-- 		(q_deg_id, 'continuous usage based v8','NASA prognostics data set', '{"q_coef":[-3.3737e-07, -7.0471e-05, 22.426]}'), 
		-- 		(q_deg_id, 'continuous usage based v9','NASA prognostics data set', '{"q_coef":[-3.2634e-07, 5.4828e-06, 21.942]}'), 
		-- 		(q_deg_id, 'continuous usage based v10','NASA prognostics data set', '{"q_coef":[-4.2623e-07, 9.5727e-05, 21.799]}'), 
		-- 		(q_deg_id, 'continuous usage based v11','NASA prognostics data set', '{"q_coef":[-3.8702e-07, 1.0279e-05, 22.481]}'), 
		-- 		(q_deg_id, 'continuous usage based v12','NASA prognostics data set', '{"q_coef":[-3.1175e-07, -0.00020311, 22.073]}'), 
		-- 		(q_deg_id, 'continuous usage based v13','NASA prognostics data set', '{"q_coef":[-2.969e-07, -0.00016466, 22.154]}'), 
		-- 		(q_deg_id, 'continuous usage based v14','NASA prognostics data set', '{"q_coef":[-4.1494e-07, 7.1112e-05, 22.216]}'), 
		-- 		(q_deg_id, 'continuous usage based v15','NASA prognostics data set', '{"q_coef":[-3.1411e-07, 1.2429e-05, 22.337]}'), 
		-- 		(q_deg_id, 'continuous usage based v16','NASA prognostics data set', '{"q_coef":[-3.6363e-07, -6.2444e-05, 22.368]}'),
		-- 		(q_deg_id, 'continuous usage based v17','NASA prognostics data set', '{"q_coef":[-4.2027e-07, 0.00012293, 22.277]}'), 
		-- 		(q_deg_id, 'continuous usage based v18','NASA prognostics data set', '{"q_coef":[-3.0471e-07, -5.2655e-05, 21.879]}'), 
		-- 		(q_deg_id, 'continuous usage based v19','NASA prognostics data set', '{"q_coef":[-4.0727e-07, 0.0001426, 21.947]}'), 
		-- 		(q_deg_id, 'continuous usage based v20','NASA prognostics data set', '{"q_coef":[-4.3942e-07, 4.7374e-06, 22.481]}'), 
		-- 		(q_deg_id, 'continuous usage based v21','NASA prognostics data set', '{"q_coef":[-2.6276e-07, -0.00030654, 22.555]}'), 
		-- 		(q_deg_id, 'continuous usage based v22','NASA prognostics data set', '{"q_coef":[-4.2984e-07, 0.00013569, 21.887]}'), 
		-- 		(q_deg_id, 'continuous usage based v23','NASA prognostics data set', '{"q_coef":[-5.2793e-07, 0.00030695, 21.818]}'), 
		-- 		(q_deg_id, 'continuous usage based v24','NASA prognostics data set', '{"q_coef":[-3.843e-07, 1.7369e-05, 22.131]}'), 
		-- 		(q_deg_id, 'continuous usage based v25','NASA prognostics data set', '{"q_coef":[-2.9939e-07, -2.2592e-06, 22.145]}'),
		-- 		(q_deg_id, 'continuous usage based v26','NASA prognostics data set', '{"q_coef":[-2.9775e-07, -0.00015524, 22.247]}'),
		-- 		(q_deg_id, 'continuous usage based v27','NASA prognostics data set', '{"q_coef":[-3.1513e-07, -0.00016422, 21.857]}'), 
		-- 		(q_deg_id, 'continuous usage based v28','NASA prognostics data set', '{"q_coef":[-4.238e-07, 0.00012079, 21.962]}'), 
		-- 		(q_deg_id, 'continuous usage based v29','NASA prognostics data set', '{"q_coef":[-4.4041e-07, -5.115e-05, 22.494]}'),
		-- 		(q_deg_id, 'continuous usage based v30','NASA prognostics data set', '{"q_coef":[-3.7765e-07, -8.7253e-05, 22.42]}'), 
		-- 		(q_deg_id, 'continuous usage based v31','NASA prognostics data set', '{"q_coef":[-3.9416e-07, 0.00025881, 21.793]}'), 
		-- 		(q_deg_id, 'continuous usage based v32','NASA prognostics data set', '{"q_coef":[-4.506e-07, 0.00017377, 21.985]}'), 
		-- 		(q_deg_id, 'continuous usage based v33','NASA prognostics data set', '{"q_coef":[-3.9432e-07, 0.00013273, 22.209]}'), 
		-- 		(q_deg_id, 'continuous usage based v34','NASA prognostics data set', '{"q_coef":[-3.7108e-07, -2.9584e-05, 22.445]}'), 
		-- 		(q_deg_id, 'continuous usage based v35','NASA prognostics data set', '{"q_coef":[-3.1957e-07, -4.8006e-05, 22.45]}'), 
		-- 		(q_deg_id, 'continuous usage based v36','NASA prognostics data set', '{"q_coef":[-3.7418e-07, -4.3055e-05, 21.789]}'),
		-- 		(q_deg_id, 'continuous usage based v37','NASA prognostics data set', '{"q_coef":[-2.7278e-07, -0.00026678, 21.854]}'), 
		-- 		(q_deg_id, 'continuous usage based v38','NASA prognostics data set', '{"q_coef":[-3.1528e-07, -0.000117, 22.354]}'), 
		-- 		(q_deg_id, 'continuous usage based v39','NASA prognostics data set', '{"q_coef":[-2.4633e-07, -0.00020162, 21.911]}'), 
		-- 		(q_deg_id, 'continuous usage based v40','NASA prognostics data set', '{"q_coef":[-3.4689e-07, -5.4951e-05, 22.182]}'), 
		-- 		(q_deg_id, 'continuous usage based v41','NASA prognostics data set', '{"q_coef":[-3.6036e-07, 3.7481e-05, 22.584]}'), 
		-- 		(q_deg_id, 'continuous usage based v42','NASA prognostics data set', '{"q_coef":[-3.5293e-07, 3.001e-05, 22.404]}'), 
		-- 		(q_deg_id, 'continuous usage based v43','NASA prognostics data set', '{"q_coef":[-5.279e-07, 0.00017683, 21.563]}'), 
		-- 		(q_deg_id, 'continuous usage based v44','NASA prognostics data set', '{"q_coef":[-4.6502e-07, 0.00012135, 22.011]}'), 
		-- 		(q_deg_id, 'continuous usage based v45','NASA prognostics data set', '{"q_coef":[-3.1929e-07, 6.5267e-05, 22.303]}'), 
		-- 		(q_deg_id, 'continuous usage based v46','NASA prognostics data set', '{"q_coef":[-2.7403e-07, -0.00022072, 22.392]}'), 
		-- 		(q_deg_id, 'continuous usage based v47','NASA prognostics data set', '{"q_coef":[-3.1557e-07, -8.0759e-05, 22.261]}'), 
		-- 		(q_deg_id, 'continuous usage based v48','NASA prognostics data set', '{"q_coef":[-3.4941e-07, -6.2977e-05, 22.46]}'), 
		-- 		(q_deg_id, 'continuous usage based v49','NASA prognostics data set', '{"q_coef":[-3.5983e-07, -0.00020625, 22.238]}'), 
		-- 		(q_deg_id, 'continuous usage based v50','NASA prognostics data set', '{"q_coef":[-5.12e-07, 0.00034588, 22.022]}'), 
		-- 		(q_deg_id, 'continuous usage based v51','NASA prognostics data set', '{"q_coef":[-4.1916e-07, -2.879e-05, 21.994]}'), 
		-- 		(q_deg_id, 'continuous usage based v52','NASA prognostics data set', '{"q_coef":[-3.7792e-07, 0.00015204, 22.101]}'), 
		-- 		(q_deg_id, 'continuous usage based v53','NASA prognostics data set', '{"q_coef":[-5.669e-07, 0.00047346, 22.035]}');
		...
		-- insert into process_tb("type_id", "description", "source", "parameters") 
		-- 	values 
		-- 		(m_deg_id, 'continuous usage based v9','experimentation', '{"r_coef":[4.463e-09, 1.7906e-05, 0.26406]}'), 
		-- 		(m_deg_id, 'continuous usage based v10','experimentation', '{"r_coef":[5.2827e-09, 1.0225e-05, 0.26731]}'), 
		-- 		(m_deg_id, 'continuous usage based v11','experimentation', '{"r_coef":[4.5443e-09, 1.4944e-05, 0.25719]}'), 
		-- 		(m_deg_id, 'continuous usage based v12','experimentation', '{"r_coef":[2.1e-09, 3.865e-05, 0.27122]}'), 
		-- 		(m_deg_id, 'continuous usage based v13','experimentation', '{"r_coef":[3.0151e-09, 4.3915e-05, 0.24904]}'), 
		-- 		(m_deg_id, 'continuous usage based v14','experimentation', '{"r_coef":[4.3418e-09, 8.9908e-06, 0.26357]}'), 
		-- 		(m_deg_id, 'continuous usage based v15','experimentation', '{"r_coef":[5.2489e-09, 1.1127e-05, 0.26076]}'), 
		-- 		(m_deg_id, 'continuous usage based v16','experimentation', '{"r_coef":[4.0262e-09, 1.8536e-06, 0.27214]}'), 
		-- 		(m_deg_id, 'continuous usage based v17','experimentation', '{"r_coef":[6.2158e-09, 2.895e-05, 0.25505]}'), 
		-- 		(m_deg_id, 'continuous usage based v18','experimentation', '{"r_coef":[4.1553e-09, 2.5395e-05, 0.2574]}'), 
		-- 		(m_deg_id, 'continuous usage based v19','experimentation', '{"r_coef":[8.5314e-09, -8.9317e-06, 0.27531]}'), 
		-- 		(m_deg_id, 'continuous usage based v20','experimentation', '{"r_coef":[3.7886e-09, 1.708e-05, 0.26105]}'), 
		-- 		(m_deg_id, 'continuous usage based v21','experimentation', '{"r_coef":[5.0273e-09, 1.1654e-05, 0.25957]}'), 
		-- 		(m_deg_id, 'continuous usage based v22','experimentation', '{"r_coef":[4.3894e-09, 1.8088e-05, 0.26013]}'), 
		-- 		(m_deg_id, 'continuous usage based v23','experimentation', '{"r_coef":[5.3582e-09, 1.7134e-05, 0.26042]}'), 
		-- 		(m_deg_id, 'continuous usage based v24','experimentation', '{"r_coef":[4.3013e-09, 3.2906e-05, 0.25131]}'), 
		-- 		(m_deg_id, 'continuous usage based v25','experimentation', '{"r_coef":[6.6488e-09, 1.5868e-06, 0.26648]}'), 
		-- 		(m_deg_id, 'continuous usage based v26','experimentation', '{"r_coef":[5.9862e-09, 7.7731e-06, 0.26547]}'), 
		-- 		(m_deg_id, 'continuous usage based v27','experimentation', '{"r_coef":[5.9367e-09, 7.6854e-06, 0.2605]}'), 
		-- 		(m_deg_id, 'continuous usage based v28','experimentation', '{"r_coef":[4.4933e-09, 1.4363e-05, 0.26353]}'), 
		-- 		(m_deg_id, 'continuous usage based v29','experimentation', '{"r_coef":[5.0158e-09, 8.7383e-06, 0.25771]}'), 
		-- 		(m_deg_id, 'continuous usage based v30','experimentation', '{"r_coef":[9.2525e-09, -8.8592e-06, 0.2806]}'), 
		-- 		(m_deg_id, 'continuous usage based v31','experimentation', '{"r_coef":[5.3569e-09, 1.6287e-05, 0.25747]}'), 
		-- 		(m_deg_id, 'continuous usage based v32','experimentation', '{"r_coef":[7.6422e-09, -7.5522e-06, 0.27377]}'), 
		-- 		(m_deg_id, 'continuous usage based v33','experimentation', '{"r_coef":[5.5357e-09, 2.0171e-05, 0.25225]}'), 
		-- 		(m_deg_id, 'continuous usage based v34','experimentation', '{"r_coef":[4.3439e-09, 1.9525e-05, 0.26091]}'), 
		-- 		(m_deg_id, 'continuous usage based v35','experimentation', '{"r_coef":[6.0067e-09, -7.8655e-06, 0.2682]}'), 
		-- 		(m_deg_id, 'continuous usage based v36','experimentation', '{"r_coef":[2.727e-09, 4.345e-05, 0.25552]}'), 
		-- 		(m_deg_id, 'continuous usage based v37','experimentation', '{"r_coef":[6.0258e-09, 2.7399e-05, 0.26721]}'), 
		-- 		(m_deg_id, 'continuous usage based v38','experimentation', '{"r_coef":[5.4383e-09, 8.1876e-06, 0.26631]}'), 
		-- 		(m_deg_id, 'continuous usage based v39','experimentation', '{"r_coef":[5.9361e-09, 6.4148e-06, 0.26254]}'), 
		-- 		(m_deg_id, 'continuous usage based v40','experimentation', '{"r_coef":[3.5657e-09, 3.661e-05, 0.25797]}'), 
		-- 		(m_deg_id, 'continuous usage based v41','experimentation', '{"r_coef":[3.3328e-09, 6.3215e-06, 0.25862]}'), 
		-- 		(m_deg_id, 'continuous usage based v42','experimentation', '{"r_coef":[3.4718e-09, 4.4836e-05, 0.25118]}'), 
		-- 		(m_deg_id, 'continuous usage based v43','experimentation', '{"r_coef":[5.3402e-09, 2.2941e-05, 0.25055]}'), 
		-- 		(m_deg_id, 'continuous usage based v44','experimentation', '{"r_coef":[5.4104e-09, 6.3773e-06, 0.26445]}'), 
		-- 		(m_deg_id, 'continuous usage based v45','experimentation', '{"r_coef":[2.0181e-09, 3.9479e-05, 0.26375]}'), 
		-- 		(m_deg_id, 'continuous usage based v46','experimentation', '{"r_coef":[3.8334e-09, 6.0894e-05, 0.25711]}'), 
		-- 		(m_deg_id, 'continuous usage based v47','experimentation', '{"r_coef":[6.1441e-09, -3.4763e-06, 0.26851]}'), 
		-- 		(m_deg_id, 'continuous usage based v48','experimentation', '{"r_coef":[7.3602e-09, -2.3269e-06, 0.27223]}'), 
		-- 		(m_deg_id, 'continuous usage based v49','experimentation', '{"r_coef":[3.9143e-09, 1.771e-05, 0.25988]}'), 
		-- 		(m_deg_id, 'continuous usage based v50','experimentation', '{"r_coef":[2.4051e-09, 6.1877e-05, 0.26515]}'), 
		-- 		(m_deg_id, 'continuous usage based v51','experimentation', '{"r_coef":[4.5074e-09, 2.3339e-05, 0.25091]}'), 
		-- 		(m_deg_id, 'continuous usage based v52','experimentation', '{"r_coef":[4.9683e-09, 2.545e-05, 0.26003]}'), 
		-- 		(m_deg_id, 'continuous usage based v53','experimentation', '{"r_coef":[4.6984e-09, 1.2255e-05, 0.26782]}'), 
		-- 		(m_deg_id, 'continuous usage based v54','experimentation', '{"r_coef":[5.1161e-09, -3.397e-07, 0.26545]}'), 
		-- 		(m_deg_id, 'continuous usage based v55','experimentation', '{"r_coef":[3.6789e-09, 4.1958e-05, 0.24969]}'), 
		-- 		(m_deg_id, 'continuous usage based v56','experimentation', '{"r_coef":[6.6797e-09, 6.1006e-06, 0.26038]}'), 
		-- 		(m_deg_id, 'continuous usage based v57','experimentation', '{"r_coef":[8.9674e-09, -1.4149e-06, 0.27114]}'), 
		-- 		(m_deg_id, 'continuous usage based v58','experimentation', '{"r_coef":[4.1374e-09, 1.3619e-05, 0.26331]}');
